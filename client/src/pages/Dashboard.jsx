  ...
  <tr 
    ...
    <td className='py-2'>
      <div className='flex gap-1 items-center'>
        <span className={clsx("text-lg", PRIOTITYSTYELS[task.priority])}>{ICONS[task.priority]}
        </span>
...
const UserTable = ({users}) => {
  ...
  const TableRow = ({user}) => (
    <tr className='border-b border-gray-200 text-gray-600 hover:bg-gray-400/10'>
      ...
      <td>
        <p 
          className={clsx("w-fit px-3 py-1 rounded-full text-sm", user?.isActive ? "bg-blue-200" : "bg-yellow-100"
          )}
        >
