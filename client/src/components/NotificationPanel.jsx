...
const data = [
    {
      ...
      notiType: "alert",
      isRead: [],
      createdAt: "2024-02-09T05:45:23",
      updatedAt: "2024-02-09T05:45:23",
      __v: 0,
    },
    {
      ...
      notiType: "alert",
      isRead: [],
      createdAt: "2024-02-09T09:32:26",
      updatedAt: "2024-02-09T09:32:26",
      __v: 0,
    },
];
      ...
      <Popover className="relative">
        ...
        >
          <Popover.Panel className='absolute -right-16 md:-right-2 z-10 mt-5 flex w-screen max-w-max px-4'>
            {({close}) =>
              data?.length >0 && (
                <div className=" w-screen max-w-md flex-auto overflow-hidden rounded-3xl bg-white text-sm leading-6 shadow-lg ring-1 ring-gray-95">
                  <div className="p-4">
